package puzzle.battlesquares.gui 
{
	...
	public class LeaderboardDisplay extends Entity 
	{
		...
		private static const DISPLAY_SPACE:int = BattleSquaresConstants.SQUARE_WIDTH + 10;
		...
		public function LeaderboardDisplay(xPos:Number, yPos:Number, gameRules:BattleSquaresRules) 
		{
		...
		public function addPlayer(playerID:int):void {
			...
			var sprite:Spritemap = new Spritemap(Assets.SQUARES, BattleSquaresConstants.SQUARE_WIDTH, BattleSquaresConstants.SQUARE_HEIGHT);
